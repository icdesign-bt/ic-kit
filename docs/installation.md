...
| Git dependency | `npm i github:icdesign-bt/ic-kit#v0.1.2` | вайбкодинг / прототип в Vite + React |
...
С тега релиза (рекомендуется после `v0.1.2`):

```bash
npm i github:icdesign-bt/ic-kit#v0.1.2
```
